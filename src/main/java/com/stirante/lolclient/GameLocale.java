...
public class GameLocale {
    ...
    public static final String PORTUGIESE_PORTUGAL = "pt_BR";
    ...
    public static final String VIETNAMESE_VIETNAM = "vn_VN";
    public static final String CHINESE_CHINA = "zh_CN";
    public static final String CHINESE_MALAYSIA = "zh_MY";
