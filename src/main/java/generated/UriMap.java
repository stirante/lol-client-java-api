...
public class UriMap {
	...
	static {
		toClass.put("\\/anti-addiction\\/v1\\/policies\\/[^/]+\\/anti-addiction-state", LolTencentAntiaddictionAntiAddictionState.class);
		...
		toClass.put("\\/lol-chat\\/v1\\/settings\\/[^/]+", Object.class);
		toClass.put("\\/lol-chat\\/v2\\/blocked-players", LolChatBlockedPlayerResource[].class);
		toClass.put("\\/lol-chat\\/v2\\/blocked-players\\/[^/]+", LolChatBlockedPlayerResource.class);
		toClass.put("\\/lol-chat\\/v2\\/conversations", LolChatConversationResource[].class);
		toClass.put("\\/lol-chat\\/v2\\/conversations\\/active", LolChatActiveConversationResource.class);
		toClass.put("\\/lol-chat\\/v2\\/conversations\\/notify", String.class);
		toClass.put("\\/lol-chat\\/v2\\/conversations\\/[^/]+", LolChatConversationResource.class);
		toClass.put("\\/lol-chat\\/v2\\/conversations\\/[^/]+\\/messages", LolChatConversationMessageResource[].class);
		toClass.put("\\/lol-chat\\/v2\\/conversations\\/[^/]+\\/participants", LolChatUserResource[].class);
		toClass.put("\\/lol-chat\\/v2\\/friend-requests", LolChatFriendRequestResource[].class);
		toClass.put("\\/lol-chat\\/v2\\/friends", LolChatFriendResource[].class);
		toClass.put("\\/lol-chat\\/v2\\/friends\\/[^/]+", LolChatFriendResource.class);
