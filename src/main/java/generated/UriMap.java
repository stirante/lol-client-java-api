...
public class UriMap {
	...
	static {
		...
		toClass.put("\\/lol-leagues\\/v1\\/eos-tier-rank", LolLeaguesLeagueTierRank[].class);
		...
		toClass.put("\\/lol-leagues\\/v2\\/summoner-leagues\\/current-summoner\\/signed-season-rewards", String.class);
		...
		toClass.put("\\/lol-ranked\\/v1\\/ranked-dashboard\\/[^/]+", LolRankedRankedDashboardInfo.class);
		toClass.put("\\/lol-ranked\\/v1\\/ranked-overview\\/[^/]+", LolRankedRankedOverviewInfo.class);
		toClass.put("\\/lol-ranked\\/v1\\/ranked-reward-update", LolRankedRankedRewardUpdate.class);
		toClass.put("\\/lol-ranked\\/v1\\/ranked-rewards-data", LolRankedRankedRewardsData.class);
		toClass.put("\\/lol-ranked\\/v1\\/signed-ranked-dashboard", SignedRankedDashboardDTO.class);
		toClass.put("\\/lol-ranked\\/v1\\/summoner-top-champs\\/[^/]+", LolRankedLeagueChampAndStat[].class);
